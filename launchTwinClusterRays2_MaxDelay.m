...
function [raysBSCluster1, distCluster1Cluster2, raysCluster2UE, isLOS] = ...
         launchTwinClusterRays2_MaxDelay(pBS, pUE, cluster1, cluster2, targetDS)
    ...
    % if abs(distMax - min(pairwiseDist(:)))< targetDS*3e8
    %     distCluster1Cluster2 = distMax + exprnd(targetDS,Nrays,1)*3e8;
    % else
    %     distCluster1Cluster2 = zeros(Nrays,1);
    % end
